...
/**
 * A React component that renders a .NET icon as an SVG.
 *
 * @param {Object} props - The component props.
 * @param {string} [props.className] - An optional CSS class name to apply to the SVG.
 * @returns {JSX.Element} - The rendered .NET icon SVG.
 */
export const DotNetIcon: React.FC<{
  className?: string;
}> = ({ className = "" }) => {
  return (
    <svg
